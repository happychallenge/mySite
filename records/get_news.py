...
def get_contents_from_chosun(url):
    ...
    try:
        ...
        result['content'] = soup.find('div', {'id':'news_body_id'}).get_text()[:400]
...
def get_contents_from_khan(url):
    ...
    try:
        result['title'] = soup.find('h1', {'id':'article_title'}).get_text()
        result['content'] = soup.find('div', {'class':'art_cont'}).get_text()[:400]
...
def get_contents_from_hankookilbo(url):
    ...
    try:
        ...
        result['content'] = soup.find('article', {'id':'article-body'}).get_text()[:400]
...
def get_contents_from_vop(url):
    ...
    try:
        result['title'] = soup.find('title').get_text()
        result['content'] = soup.find('div', {'class':'contents'}).get_text()[:400]
...
def get_contents_from_imbc(url):
    ...
    try:
        result['title'] = soup.find('title').get_text()
        result['content'] = soup.find('section', {'class':'body'}).get_text()[:400]
...
def get_contents_from_sisain(url):
    ...
    try:
        result['title'] = soup.find('title').get_text()
        result['content'] = soup.find('div', {'itemprop':'articleBody'}).get_text()[:400]
        span = soup.select('span.arl_view_date')[0].get_text().strip()
        result['published_at'] = span[:4] + '-' + span[6:8] + '-' + span[10:12]
    except AttributeError as e:
        print(e)
...
def get_contents_from_naeil(url):
    ...
    try:
        ...
        result['content'] = soup.find('div', {'id':'contents'}).get_text()[:400]
...
def get_contents_from_ddanzi(url):
    ...
    try:
        result['title'] = soup.find('title').get_text()
        result['content'] = soup.find('div', {'class':'read_body'}).get_text()[:400]
...
def get_contents_from_tf(url):
    ...
    try:
        result['title'] = soup.find('title').get_text()
        result['content'] = soup.find('div', {'id':'content_area'}).get_text()[:400]
...
def get_contents_from_asiatoday(url):
    ...
    try:
        result['title'] = soup.find('title').get_text()
        result['content'] = soup.find('dl', {'itemprop':'articleBody'}).get_text()[:400]
...
def get_contents_from_lawtimes(url):
    ...
    try:
        result['title'] = soup.find('title').get_text()
        result['content'] = soup.find('article', {'itemprop':'articleBody'}).get_text()[:400]
...
def get_contents_from_redian(url):
    ...
    try:
        result['title'] = soup.find('title').get_text()
        result['content'] = soup.find('div', {'class':'redian-view-text'}).get_text()[:400]
...
def get_contents_from_mediaus(url):
    ...
    try:
        result['title'] = soup.find('title').get_text()
        result['content'] = soup.find('div', {'class':'content'}).get_text()[:400]
